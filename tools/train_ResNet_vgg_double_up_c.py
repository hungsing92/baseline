...
>>>>>>> e519416c00becb124b84fb3d36c8bd5e7a20b573
...
def run_train():
    ...
    train_writer = tf.summary.FileWriter( './outputs/tensorboard/RR_context',
                                      sess.graph)
...
#         # saver_1.restore(sess, './outputs/check_points/vgg_16.ckpt')
        ...
        for iter in range(max_iter):
            ...
            if vis and iter%iter_debug==0:
                ...
                probs, boxes3d = rcnn_nms_2d(batch_fuse_probs, batch_fuse_deltas, batch_rois3d, batch_fuse_deltas_2d, batch_rgb_rois[:,1:],rgb_shape, threshold=0.05)
